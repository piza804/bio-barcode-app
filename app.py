...
if menu == "バーコード登録":
    ...
    """
    components.html(quagga_component, height=500, scrolling=False)
    ...
    # 隠し入力欄
    barcode_data = st.text_input("バーコード番号（自動入力）",
